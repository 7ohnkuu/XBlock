...
const EN = {
  ...
  "banner.reload": "XBlock was reloaded. Refresh this page to keep using it.",
  "banner.reloadAction": "Refresh",
  ...
  "queue.optionsFailed": "Could not open Options: {error}",
...
const ZH: Record<keyof typeof EN, string> = {
  ...
  "banner.open": "打開托盤",
  "banner.close": "收起托盤",
  "banner.reload": "XBlock 已重新載入。請重整此頁才能繼續使用。",
  "banner.reloadAction": "重整頁面",
  ...
  "queue.optionsFailed": "無法打開選項頁：{error}",
  "opt.title": "XBlock 選項",
